    ...
    override fun getView(position: Int): View {
        ...
        if (position % 2 == 0) { //
            ...
            llHot.setOnClickListener {
                Toast.makeText(mContext,"点击第$position 条人气",Toast.LENGTH_SHORT).show()
            }
            ...
            tvTag1.setOnClickListener {
                Toast.makeText(mContext,"点击第$position 条111",Toast.LENGTH_SHORT).show()
            }

            val tvTag2=view.findViewById<TextView>(R.id.tv_tag2)
            tvTag2.setOnClickListener {
                Toast.makeText(mContext,"点击第$position 条222",Toast.LENGTH_SHORT).show()
            }

            val tvBottom = view.findViewById<TextView>(R.id.tv_bottom)
            tvBottom?.setOnClickListener {
                Toast.makeText(mContext,"点击第$position 条底部按钮",Toast.LENGTH_SHORT).show()
            }
        }
        return view
    }
